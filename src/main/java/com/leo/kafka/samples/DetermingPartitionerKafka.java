...
public class DetermingPartitionerKafka {
	/**
	 * LOG
	 */
	private static Logger logger = LoggerFactory.getLogger(DetermingPartitionerKafka.class);
	/**
	...
	public static void main(String[] args) {
		...
		while(true){
			...
			KeyedMessage<String, String> data = new KeyedMessage<String, String>("website-hits","192.168.1."+new Random().nextInt(10), msg);
			producer.send(data);	
			try {
